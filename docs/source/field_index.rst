...
|          |                |            |          | .155.3766.1103 |
+----------+----------------+------------+----------+----------------+
| 53       | (Uranium+Tho-  | (U+Th)/He  | 47       | Fanale &       |
|          | rium)/Helium   |            |          | Schaeffer      |
|          |                |            |          | (1965),        |
|          |                |            |          | ht             |
|          |                |            |          | tps://doi.org/ |
|          |                |            |          | 10.1126/scienc |
...
|          |                |            |          | 21%2Fed060p682 |
+----------+----------------+------------+----------+----------------+
| 91       | Accelerator    | AMS        | 88       | Fifield        |
|          | Mass           |            |          | (1999),        |
|          | Spectrometry   |            |          | https://doi.or |
|          | (non-specific) |            |          | g/10.1088/0034 |
|          |                |            |          | -4885/62/8/202 |
+----------+----------------+------------+----------+----------------+
