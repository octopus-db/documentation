...
|          |                |            |          | 516--528.      |
+----------+----------------+------------+----------+----------------+
| 2 [#]_   | Radiocarbon    | C14        | 14       | Anderson,      |
|          | Dating         |            |          | Libby,         |
|          |                |            |          | Weinhouse,     |
|          |                |            |          | Reid,          |
|          |                |            |          | Kirshenbaum &  |
...
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 3 [#]_   | Cation Ratio   | CRD        | 3        | Dorn (1983)    |
|          | Dating         |            |          |                |
+----------+----------------+------------+----------+----------------+
...
|          |                |            |          | Agency (IAEA). |
+----------+----------------+------------+----------+----------------+
| 5 [#]_   | Oxidisable     | OCR        | 5        | Frink (1996)   |
|          | Carbon Ratio   |            |          |                |
+----------+----------------+------------+----------+----------------+
| 6 [#]_   | Optically      | OSL        | 47       | Huntley,       |
...
|          | (corrected)    |            |          |                |
+----------+----------------+------------+----------+----------------+
| 18 [#]_  | Tritium/Helium | 3H/3He     | 14       | Kaufmann &     |
|          |                |            |          | Libby (1954)   |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 19 [#]_  | Beryllium-10   | Be-10      | 14       | Arnold (1956)  |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
...
|          |                |            |          | INS-19.        |
+----------+----------------+------------+----------+----------------+
| 21 [#]_  | Silicon-32     | Si-32      | 14       | Lal, Goldberg  |
|          |                |            |          | & Koide (1960) |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 22 [#]_  | Chlorine-36    | Cl-36      | 14       | Davis &        |
|          |                |            |          | Schaeffer      |
|          |                |            |          | (1955)         |
+----------+----------------+------------+----------+----------------+
| 23 [#]_  | Argon-39       | Ar-39      | 14       | Loosli &       |
|          |                |            |          | Oeschger       |
|          |                |            |          | (1968)         |
+----------+----------------+------------+----------+----------------+
| 24 [#]_  | Calcium-41     | Ca-41      | 14       | Raisbeck &     |
|          |                |            |          | Yiou (1979)    |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 25 [#]_  | Manganese-53   | Mg-53      | 14       | Wilkinson &    |
|          |                |            |          | Sheline (1955) |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 26 [#]_  | Krypton-81     | Kr-81      | 14       | Marti (1967)   |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 27 [#]_  | Iodine-129     | I-129      | 14       | Takagi, Hampel |
|          |                |            |          | & Kirsten      |
|          |                |            |          | (1974)         |
+----------+----------------+------------+----------+----------------+
...
|          |                |            |          | 9, 369.        |
+----------+----------------+------------+----------+----------------+
| 35 [#]_  | 176Lu/176Hf    | Lu/Hf      | 29       | Herr, Merz,    |
|          |                |            |          | Eberhardt &    |
|          |                |            |          | Signer (1958)  |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 36 [#]_  | 187Re/187Os    | Re/Os      | 29       | Herr & Merz    |
|          |                |            |          | (1955)         |
+----------+----------------+------------+----------+----------------+
| 37 [#]_  | U/Th/Pb        | U/Th/Pb    | 29       | Holmes (1911)  |
|          | (non-specific) |            |          |                |
+----------+----------------+------------+----------+----------------+
...
|          |                |            |          | 121--131.      |
+----------+----------------+------------+----------+----------------+
| 41 [#]_  | Caesium-137    | 137Cs      | 39       | Williams       |
|          |                |            |          | (1995)         |
+----------+----------------+------------+----------+----------------+
...
|          | disequilibrium |            |          |                |
+----------+----------------+------------+----------+----------------+
| 43 [#]_  | 230Th/U        | Th/U       | 8        | Barnes, Lang & |
|          |                |            |          | Potratz (1956) |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 44 [#]_  | 234U/238U      | U/U        | 8        | Thurber (1962) |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
...
|          | (non-specific) |            |          |                |
+----------+----------------+------------+----------+----------------+
| 49 [#]_  | Infrared       | IR-PL      | 47       | Prasad,        |
|          | Pho            |            |          | Poolton, Kook  |
|          | toluminescence |            |          | & Jain (2017)  |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 50 [#]_  | Infrared       | IR-RF      | 47       | Trautmann,     |
|          | Rad            |            |          | Krbetschek,    |
|          | iofluorescence |            |          | Dietrich &     |
|          |                |            |          | Stolz (1998)   |
|          |                |            |          |                |
+----------+----------------+------------+----------+----------------+
| 51 [#]_  | Infrared       | IRSL       | 47       | Hütt, Jaek &   |
|          | Stimulated     |            |          | Tchonka (1988) |
|          | Luminescence   |            |          |                |
+----------+----------------+------------+----------+----------------+
| 52 [#]_  | Alpha-recoil   | ART        | 47       | Huang & Walker |
|          | track dating   |            |          | (1967)         |
+----------+----------------+------------+----------+----------------+
| 53 [#]_  | (Uranium+T     | (U+Th)/He  | 47       | Fanale &       |
|          | horium)/Helium |            |          | Schaeffer      |
|          |                |            |          | (1965)         |
+----------+----------------+------------+----------+----------------+
| 54 [#]_  | Fission track  | FT         | 47       | Price & Walker |
|          |                |            |          | (1962)         |
+----------+----------------+------------+----------+----------------+
...
|          | weathering     |            |          |                |
+----------+----------------+------------+----------+----------------+
| 65 [#]_  | Obsidian       | Obsid      | 63       | Friedman &     |
...
|          | (non-specific) |            |          |                |
+----------+----------------+------------+----------+----------------+
| 69 [#]_  | Oxygen isotope | Oxygen     | 68       | Emiliani       |
|          | chro           |            |          | (1954)         |
|          | nostratigraphy |            |          |                |
+----------+----------------+------------+----------+----------------+
...
|          | (non-specific) |            |          |                |
+----------+----------------+------------+----------+----------------+
| 74 [#]_  | A              | A-Magnet   | 73       | Harold (1960)  |
|          | rchaeomagnetic |            |          |                |
|          | dating         |            |          |                |
+----------+----------------+------------+----------+----------------+
...
|          |                |            |          | UK.            |
+----------+----------------+------------+----------+----------------+
| 90 [#]_  | Cherenkov      | LSC-C      | 88       | Rengan (1983)  |
|          | Counting       |            |          |                |
+----------+----------------+------------+----------+----------------+
| 91 [#]_  | Accelerator    | AMS        | 88       | Fifield (1999) |
|          | Mass           |            |          |                |
|          | Spectrometry   |            |          |                |
|          | (non-specific) |            |          |                |
+----------+----------------+------------+----------+----------------+
